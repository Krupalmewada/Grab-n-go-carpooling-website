...
<img src="images/others/3 (1).jpg" class="card-img-top" alt="..." >
<body>
...
<nav class="navbar navbar-expand-custom navbar-mainbg">
	...
	<div class="div1">
		<div class="div2"style="margin-right: 5px" onclick="window.open('signup_rider.php','_self');" >
		<i class="fas fa-car">Rider</i>
		</div>
		<div class="div2" onclick="window.open('signup_passenger.php','_self');">
		<i class="fas fa-street-view">Pooler</i>
		</div>
		<div class="divs" onclick="window.open(' login.php','_self');">
                    <a href="login.php"><i class="fas fa-user-alt" ></i>Login</a>
        </div>
        <div class="divs" onclick="window.open(' signup.php','_self');">
            <a class="nav-link"href="signup.php"><i class="fas fa-portrait"></i>Register</a>
		</div>
	</div>
  ...
  <!-- <nav class="navbar navbar-expand-lg navbar-dark ">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <a class="navbar-brand" href="riderlist.php">Rider
    </a>
    <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent"
      aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
      <span class="navbar-toggler-icon"></span>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <a class="navbar-brand" href="contactus.php">Contact Us
    </a>
    <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent"
      aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
      <span class="navbar-toggler-icon"></span>
...
<!-- 
      ...
      <a href="signup.php"><button type="button" class="btn btn-outline-success mr-1">Register</button></a>
...
<?php include'footer.php'?>
  ...
  <!-- <div class="card mb-3 mt-5 container-sm">
    <img src="images/others/3 (1).jpg" class="card-img-top" alt="...">
    <div class="card-body">
      <h5 class="card-title">Benifit as Car Pooler</h5>
      <p class="card-text">
