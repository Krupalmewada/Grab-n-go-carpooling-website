...
.div2:hover {
  background-color: rgba(200, 0, 0, 0.7); /* Change background color when hovering */
	color:black;
	font-weight:bold;
...
<img src="https://images.unsplash.com/photo-1494122353634-c310f45a6d3c?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80" class="card-img-top" alt="..." >
<body>
...
<nav class="navbar navbar-expand-custom navbar-mainbg">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="javascript:void(0);"onclick="window.open('index.php','_self'); target='_self'"><i class="fas fa-home"></i>Home</a>
                </li>
                <li class="nav-item ">
    ...
    <h2 style="margin-top:50px; margin-left:50px;">Register As<span class="badge badge-secondary"></span></h2>
    </div>
